export interface TwilioVoicePlugin {
     ...
     */
    addListener(eventName: 'callConnected', listenerFunc: () => void): Promise<PluginListenerHandle>;
    /**
     ...
     * @param listenerFunc - Callback function to handle the event
     */
    addListener(eventName: 'callDisconnected', listenerFunc: () => void): Promise<PluginListenerHandle>;
    /**
     ...
     */
    addListener(eventName: 'callFailed', listenerFunc: (error: CallFailedEvent) => void): Promise<PluginListenerHandle>;
    /**
